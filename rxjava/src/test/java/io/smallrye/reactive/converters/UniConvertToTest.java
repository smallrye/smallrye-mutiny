...
import io.smallrye.reactive.converters.uni.ToFlowable;
import io.smallrye.reactive.converters.uni.ToMaybe;
import io.smallrye.reactive.converters.uni.ToObservable;
...
public class UniConvertToTest {
    ...
    public void testCreatingASingle() {
        Single<Optional<Integer>> single = Uni.createFrom().item(1).convert().with(new ToSingle<>());
    ...
    public void testCreatingASingleFromNull() {
        Single<Optional<Integer>> single = Uni.createFrom().item((Integer) null).convert().with(new ToSingle<>());
        assertThat(single).isNotNull();
        single
                .test()
    ...
    public void testCreatingAMaybe() {
        Maybe<Integer> maybe = Uni.createFrom().item(1).convert().with(new ToMaybe<>());
    ...
    public void testCreatingAMaybeFromNull() {
        Maybe<Integer> maybe = Uni.createFrom().item((Integer) null).convert().with(new ToMaybe<>());
        assertThat(maybe).isNotNull();
        maybe
                .test()
                .assertComplete()
    ...
    public void testCreatingAMaybeWithFailure() {
        Maybe<Integer> maybe = Uni.createFrom().<Integer> failure(new IOException("boom")).convert().with(new ToMaybe<>());
        assertThat(maybe).isNotNull();
    ...
    public void testCreatingAnObservable() {
        Observable<Integer> observable = Uni.createFrom().item(1).convert().with(new ToObservable<>());
    ...
    public void testCreatingAnObservableFromNull() {
        Observable<Integer> observable = Uni.createFrom().item((Integer) null).convert().with(new ToObservable<>());
        assertThat(observable).isNotNull();
        observable
                .test()
                .assertComplete()
    ...
    public void testCreatingAFlowable() {
        Flowable<Integer> flowable = Uni.createFrom().item(1).convert().with(new ToFlowable<>());
    ...
    public void testCreatingAFlowableFromNull() {
        Flowable<Integer> flowable = Uni.createFrom().item((Integer) null).convert().with(new ToFlowable<>());
        assertThat(flowable).isNotNull();
        flowable
                .test()
                .assertComplete()
