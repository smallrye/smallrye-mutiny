...
class UniContextForkTest {
    ...
    void checkBoundaries() {
        ...
        Integer result = Uni.createFrom().item(69)
                .withContext((uni, ctx) -> {
                    trace.add(ctx.getOrElse(123, () -> "!!!"));
                    trace.add(ctx.getOrElse(456, () -> "!!!"));
                    return uni.onItem().invoke(() -> {
                        trace.add("-" + ctx.getOrElse(123, () -> "!!!"));
                        trace.add("-" + ctx.getOrElse(456, () -> "!!!"));
                    });
                })
                ...
                .awaitUsing(rootContext).atMost(Duration.ofSeconds(1));
