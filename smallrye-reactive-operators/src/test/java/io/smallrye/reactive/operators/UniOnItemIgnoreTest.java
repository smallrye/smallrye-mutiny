...
public class UniOnItemIgnoreTest {
    ...
    public void testIgnoreAndContinueWithValue() {
        assertThat(Uni.createFrom().item(24).onItem().ignore().andContinueWith(42).await().indefinitely())
                .isEqualTo(42);
    }
    ...
    public void testIgnoreAndContinueWithValueSupplierReturningNull() {
        assertThat(Uni.createFrom().item(24).onItem().ignore().andContinueWith(() -> null).await().indefinitely())
                .isEqualTo(null);
    }
