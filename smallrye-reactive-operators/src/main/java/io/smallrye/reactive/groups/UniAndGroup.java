 ...
 * {@link Uni unis} have emitted a {@code result} event and then combines the different results into a
 * resolved successfully aggregating their values into a {@link io.smallrye.reactive.tuples.Tuple}, or using a
 * combinator function.
 * <p>
...
public class UniAndGroup<T1> {
    ...
    /**
     * Combines the current {@link Uni} with the given ones.
     * Once all {@link Uni} have completed successfully, the result can be retrieved as a {@link Tuple5} or computed
