...
public class UniAndTest {
    ...
    public void testWithTwoSimpleUnis() {
        ...
        UniAssertSubscriber<Tuple2<Integer, Integer>> subscriber = uni.and().uni(uni2).asTuple().subscribe()
    ...
    public void testWithTwoOneFailure() {
        UniAssertSubscriber<Tuple2<Integer, Integer>> subscriber = Uni.createFrom().item(1).and()
                .uni(Uni.createFrom().<Integer> failure(new IOException("boom"))).asTuple()
    ...
    public void testWithTwoFailures() {
        UniAssertSubscriber<Tuple3<Integer, Integer, Integer>> subscriber = Uni.createFrom().item(1).and().unis(
    ...
    public void testWithFiveUnis() {
        ...
        UniAssertSubscriber<Tuple5<Integer, Integer, Integer, Integer, Integer>> subscriber = uni.and()
                .unis(uni, uni2, uni3, uni4).asTuple().subscribe()
                .withSubscriber(UniAssertSubscriber.create());
    ...
    public void testWithFourUnis() {
        ...
        UniAssertSubscriber<Tuple4<Integer, Integer, Integer, Integer>> subscriber = uni.and().unis(uni, uni2, uni3).asTuple()
                .subscribe().withSubscriber(UniAssertSubscriber.create());
