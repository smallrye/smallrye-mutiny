...
```java linenums="1"
{=snippet:insert("java/tutorials/CreatingUniTest.java", "pipeline")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/CreatingUniTest.java", "subscription")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/CreatingUniTest.java", "simple")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/CreatingUniTest.java", "supplier")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/CreatingUniTest.java", "failed")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/CreatingUniTest.java", "null")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/CreatingUniTest.java", "emitter")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/CreatingUniTest.java", "cs")}
```
