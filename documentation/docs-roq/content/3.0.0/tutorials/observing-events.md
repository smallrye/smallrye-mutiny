...
```java linenums="1"
{=snippet:insert("java/tutorials/ObserveTest.java", "invoke")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/ObserveTest.java", "invoke-all")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/ObserveTest.java", "call")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/ObserveTest.java", "close")}
```
