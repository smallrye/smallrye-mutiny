---
title: "Take/Skip the first or last items"
layout: page
tags:
- guide
- beginner
...
```java linenums="1"
{=snippet:insert("java/guides/operators/SelectAndSkipTest.java", "take-first")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/SelectAndSkipTest.java", "take-last")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/SelectAndSkipTest.java", "take-while")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/SelectAndSkipTest.java", "take-for")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/SelectAndSkipTest.java", "skip-first")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/SelectAndSkipTest.java", "skip-last")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/SelectAndSkipTest.java", "skip-while")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/SelectAndSkipTest.java", "skip-for")}
```
