---
title: "Creating `Multi` pipelines"
layout: page
tags:
- tutorial
- beginner
...
```java linenums="1"
{=snippet:insert("java/tutorials/CreatingMultiTest.java", "pipeline")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/CreatingMultiTest.java", "subscription")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/CreatingMultiTest.java", "simple")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/CreatingMultiTest.java", "supplier")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/CreatingMultiTest.java", "failed")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/CreatingMultiTest.java", "empty")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/CreatingMultiTest.java", "emitter")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/CreatingMultiTest.java", "ticks")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/CreatingMultiTest.java", "generator")}
```
