...
```java linenums="1"
{=snippet:insert("java/guides/operators/UniJoinTest.java", "join-all")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/UniJoinTest.java", "join-all-ff")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/UniJoinTest.java", "join-first")}
```

If you want to have the first `Uni` that emits a value (and forget the first failures), then:

```java linenums="1"
{=snippet:insert("java/guides/operators/UniJoinTest.java", "join-first-withitem")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/UniJoinTest.java", "builder")}
```
