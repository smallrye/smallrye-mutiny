...
```java linenums="1"
{=snippet:insert("java/tutorials/HandlingFailuresTest.java", "invoke")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/HandlingFailuresTest.java", "transform")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/HandlingFailuresTest.java", "recover-item")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/HandlingFailuresTest.java", "recover-completion")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/HandlingFailuresTest.java", "recover-switch")}
```
