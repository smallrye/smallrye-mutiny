...
```java linenums="1"
{=snippet:insert("java/tutorials/TransformItemsTest.java", "uni-transform")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/TransformItemsTest.java", "multi-transform")}
```

The produced items are passed to the downstream subscriber:

```java linenums="1"
{=snippet:insert("java/tutorials/TransformItemsTest.java", "multi-transform-2")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/TransformItemsTest.java", "chain")}
```
