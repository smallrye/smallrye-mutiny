---
title: "Grouping items from Multi"
layout: page
tags:
- guide
- intermediate
...
```java linenums="1"
{=snippet:insert("java/guides/operators/GroupingItemsTest.java", "groupIntoLists")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/GroupingItemsTest.java", "timeBasedListGrouping")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/GroupingItemsTest.java", "sizeAndTimeBasedListGrouping")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/GroupingItemsTest.java", "groupIntoMultis")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/GroupingItemsTest.java", "timeBasedGrouping")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/GroupingItemsTest.java", "groupByKey")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/GroupingItemsTest.java", "groupByKeyAndValue")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/GroupingItemsTest.java", "groupByWithMerge")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/GroupingItemsTest.java", "groupByDeadlock")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/GroupingItemsTest.java", "groupByWithConcatenate")}
```
