---
title: "Transforming items asynchronously"
layout: page
tags:
- tutorial
- beginner
...
```java linenums="1"
{=snippet:insert("java/tutorials/TransformItemsAsyncTest.java", "service")}
```

To call this service, you need to transform the item received from the first `Uni` into the `Uni` returned by the service:

```java linenums="1"
{=snippet:insert("java/tutorials/TransformItemsAsyncTest.java", "call")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/TransformItemsAsyncTest.java", "chain")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/TransformItemsAsyncTest.java", "uni-to-multi")}
```

This code creates a stream of two elements, duplicating the received item.

```java linenums="1"
{=snippet:insert("java/tutorials/TransformItemsAsyncTest.java", "uni-to-multi-2")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/TransformItemsAsyncTest.java", "merge-concat")}
```
...
```java
{=snippet:insert("java/tutorials/TransformItemsAsyncTest.java", "merge-concurrency")}
```
...
```java linenums="1"
{=snippet:insert("java/tutorials/TransformItemsAsyncTest.java", "merge-concat-multi")}
```
