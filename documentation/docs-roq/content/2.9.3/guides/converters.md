...
```java linenums="1"
{=snippet:insert("java/guides/integration/ReactorTest.java", "reactor-multi-create")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/integration/ReactorTest.java", "reactor-uni-create")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/integration/ReactorTest.java", "reactor-create-multi")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/integration/ReactorTest.java", "reactor-create-uni")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/integration/ReactorTest.java", "uni-export")}
{=snippet:insert("java/guides/integration/ReactorTest.java", "multi-export")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/integration/RxJavaTest.java", "rx-multi-create-observable")}
```

Converting a `Flowable` is easier, as it's a `Publisher`:

```java linenums="1"
{=snippet:insert("java/guides/integration/RxJavaTest.java", "rx-multi-create-flowable")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/integration/RxJavaTest.java", "rx-multi-create-single")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/integration/RxJavaTest.java", "rx-uni-create-observable")}
```

The creation from a `Flowable` can be done using the Reactive Streams interoperability:

```java linenums="1"
{=snippet:insert("java/guides/integration/RxJavaTest.java", "rx-uni-create-flowable")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/integration/RxJavaTest.java", "rx-uni-create-single")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/integration/RxJavaTest.java", "create-rx-from-multi")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/integration/RxJavaTest.java", "create-rx-from-uni")}
```
