---
title: "How to deal with dropped exceptions?"
layout: page
tags:
- guide
- advanced
...
```java linenums="1"
{=snippet:insert("java/guides/infrastructure/DroppedExceptionTest.java", "code")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/infrastructure/DroppedExceptionTest.java", "override-handler")}
```
