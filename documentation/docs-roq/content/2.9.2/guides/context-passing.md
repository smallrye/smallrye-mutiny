...
```java linenums="1"
{=snippet:insert("java/guides/ContextPassingTest.java", "contextManipulation")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/ContextPassingTest.java", "contextSampleUsage")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/ContextPassingTest.java", "contextAttachedSampleUsage")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/ContextPassingTest.java", "builderUsage")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/ContextPassingTest.java", "emitterUsage")}
```
