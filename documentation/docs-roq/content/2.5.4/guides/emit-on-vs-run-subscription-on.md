---
title: "What is the difference between emitOn and runSubscriptionOn?"
layout: page
tags:
- guide
- intermediate
...
```java linenums="1"
{=snippet:insert("java/guides/operators/RunSubscriptionOnTest.java", "emitOn")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/RunSubscriptionOnTest.java", "runSubscriptionOn")}
```
