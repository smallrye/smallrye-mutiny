...
```java linenums="1"
{=snippet:insert("java/guides/integration/ImperativeToReactiveTest.java", "uni-runSubscriptionOn")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/integration/ImperativeToReactiveTest.java", "multi-emitOn")}
```
