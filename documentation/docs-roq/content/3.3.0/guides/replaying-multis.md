...
```java linenums="1"
{=snippet:insert("java/guides/operators/ReplayTest.java", "replay-all")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/ReplayTest.java", "replay-last")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/ReplayTest.java", "replay-seed")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/ReplayTest.java", "replay-errors")}
```
