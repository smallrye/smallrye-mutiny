...
```java linenums="1"
{=snippet:insert("java/guides/UncheckedTest.java", "rethrow")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/UncheckedTest.java", "transform")}
```
You can also wrap consumers such as in:

```java linenums="1"
{=snippet:insert("java/guides/UncheckedTest.java", "invoke")}
```
