---
title: "How can I integrate Mutiny with my framework?"
layout: page
tags: [guide, advanced]
---
...
```java linenums="1"
{=snippet:insert("java/guides/infrastructure/InfrastructureTest.java", "infra")}
```

You can configure the default executor using the `Infrastructure.setDefaultExecutor` method:

```java linenums="1"
{=snippet:insert("java/guides/infrastructure/InfrastructureTest.java", "set-infra")}
```
