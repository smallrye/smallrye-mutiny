...
```java linenums="1"
{=snippet:insert("java/guides/operators/MergeConcatTest.java", "merge")}
```

For example, we can merge multiple streams emitting periodical events:

```java linenums="1"
{=snippet:insert("java/guides/operators/MergeConcatTest.java", "merge-ticks")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/MergeConcatTest.java", "concat")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/MergeConcatTest.java", "concatenate-strings")}
```
