...
```java linenums="1"
{=snippet:insert("java/guides/integration/ReactiveToImperativeTest.java", "await")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/integration/ReactiveToImperativeTest.java", "atMost")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/integration/ReactiveToImperativeTest.java", "iterable")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/integration/ReactiveToImperativeTest.java", "stream")}
```