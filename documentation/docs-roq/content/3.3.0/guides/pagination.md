---
title: "How to use paginated APIs?"
layout: page
...
```java linenums="1"
{=snippet:insert("java/guides/operators/PaginationTest.java", "code")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/PaginationTest.java", "code2")}
```