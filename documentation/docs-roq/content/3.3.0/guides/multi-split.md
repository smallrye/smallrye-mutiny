---
title: "Splitting a Multi into several Multi"
layout: page
...
```java linenums="1"
{=snippet:insert("java/guides/operators/SplitTest.java", "enum")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/operators/SplitTest.java", "splits")}
```
