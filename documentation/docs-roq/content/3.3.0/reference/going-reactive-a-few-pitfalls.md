---
title: "Going reactive: a few pitfalls"
layout: page
...
```java linenums="1"
{=snippet:insert("java/guides/reference/PitfallsTest.java", "noMagicJoin")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/reference/PitfallsTest.java", "inMemoryData")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/reference/PitfallsTest.java", "suspiciousPublisher")}
```
...
```java linenums="1"
{=snippet:insert("java/guides/reference/PitfallsTest.java", "flatmap-ism")}
```
