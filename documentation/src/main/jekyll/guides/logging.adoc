...
----
include::{include_dir}/OperatorLoggingTest.java[tags=log]
----
...
[source,java,indent=0]
----
include::{include_dir}/OperatorLoggingTest.java[tags=set-logger]
----

[TIP]
Note that this is only useful to do when embedding Mutiny in your own stack, some frameworks like https://quarkus.io[Quarkus] will already have defined the correct logging strategy.
