:page-layout: guides
:page-guide-id: converters
:page-liquid:
:include_dir: ../../../../src/test/java/guides/integration
...
https://projectreactor.io/[Project Reactor] is a popular reactive programming library.
...
[source, java, indent=0]
----
include::{include_dir}/ReactorTest.java[tag=reactor-multi-create]
----
...
[source, java, indent=0]
----
include::{include_dir}/ReactorTest.java[tag=reactor-uni-create]
----
...
[source, java, indent=0]
----
include::{include_dir}/ReactorTest.java[tag=reactor-create-multi]
----
...
[source, java, indent=0]
----
include::{include_dir}/ReactorTest.java[tag=reactor-create-uni]
----
...
[source, java, indent=0]
----
include::{include_dir}/ReactorTest.java[tag=uni-export]
...
[source, java, indent=0]
----
include::{include_dir}/RxJavaTest.java[tag=rx-multi-create-observable]
----
...
[source, java, indent=0]
----
include::{include_dir}/RxJavaTest.java[tag=rx-multi-create-flowable]
----
...
[source, java, indent=0]
----
include::{include_dir}/RxJavaTest.java[tag=rx-multi-create-single]
----
...
[source, java, indent=0]
----
include::{include_dir}/RxJavaTest.java[tag=rx-uni-create-observable]
----
...
[source, java, indent=0]
----
include::{include_dir}/RxJavaTest.java[tag=rx-uni-create-flowable]
----
...
[source, java, indent=0]
----
include::{include_dir}/RxJavaTest.java[tag=rx-uni-create-single]
----
...
[source, java, indent=0]
----
include::{include_dir}/RxJavaTest.java[tag=create-rx-from-multi]
----
...
[source, java, indent=0]
----
include::{include_dir}/RxJavaTest.java[tag=create-rx-from-uni]
----
