...
----
include::{include_dir}/ReactiveToImperativeTest.java[tag=await]
----
...
[source, java, indent=0]
----
include::{include_dir}/ReactiveToImperativeTest.java[tag=atMost]
----
...
[source, java, indent=0]
----
include::{include_dir}/ReactiveToImperativeTest.java[tag=iterable]
----
...
[source, java, indent=0]
----
include::{include_dir}/ReactiveToImperativeTest.java[tag=stream]
----