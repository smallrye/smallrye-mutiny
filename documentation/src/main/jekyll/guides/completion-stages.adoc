:page-layout: guides
:page-guide-id: completion-stages
:page-liquid:
:page-show-toc: true
...
The outcome is used to complete the the returned `CompletionStage`.
...
TIP: You can also _cache_ the outcome with `Uni.memoize().indefinitely()`.
...
----
include::{include_dir}/CompletionStageTest.java[tags=uni-subscribe-cs]
----
...
[source,java,indent=0]
----
include::{include_dir}/CompletionStageTest.java[tags=uni-subscribe-cs-twice]
----
...
[source,java,indent=0]
----
include::{include_dir}/CompletionStageTest.java[tags=create-uni]
----
...
[source,java,indent=0]
----
include::{include_dir}/CompletionStageTest.java[tags=create-multi]
----
