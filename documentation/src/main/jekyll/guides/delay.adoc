...
----
include::{include_dir}/DelayTest.java[tags=delay-by]
----
...
[source,java,indent=0]
----
include::{include_dir}/DelayTest.java[tags=delay-until]
----
...
[source,java,indent=0]
----
include::{include_dir}/DelayTest.java[tags=delay-multi]
----
...
[source,java,indent=0]
----
include::{include_dir}/DelayTest.java[tags=delay-multi-random]
----
...
[source,java,indent=0]
----
include::{include_dir}/DelayTest.java[tags=throttling-multi]
----

TIP: The `onOverflow().drop()` is used to avoid the _ticks_ to fail if the other stream (`multi`) is too slow.
