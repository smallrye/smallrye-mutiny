...
So, here is the big question: _how to you deal with blocking code?_
...
----
include::{include_dir}/ImperativeToReactiveTest.java[tag="uni-runSubscriptionOn"]
----
...
[source, java, indent=0]
----
include::{include_dir}/ImperativeToReactiveTest.java[tag="multi-emitOn"]
----
