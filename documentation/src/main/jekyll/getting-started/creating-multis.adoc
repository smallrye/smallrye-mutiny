...
----
include::{include_dir}/CreatingMultiTest.java[tag=pipeline]
----
...
[source, java, indent=0]
----
include::{include_dir}/CreatingMultiTest.java[tag=subscription]
----
...
[source, java, indent=0]
----
include::{include_dir}/CreatingMultiTest.java[tag=simple]
----
...
[source, java, indent=0]
----
include::{include_dir}/CreatingMultiTest.java[tag=supplier]
----
...
[source, java, indent=0]
----
include::{include_dir}/CreatingMultiTest.java[tag=failed]
----
...
[source, java, indent=0]
----
include::{include_dir}/CreatingMultiTest.java[tag=empty]
----
...
[source, java, indent=0]
----
include::{include_dir}/CreatingMultiTest.java[tag=emitter]
----
...
[source, java, indent=0]
----
include::{include_dir}/CreatingMultiTest.java[tag=ticks]
----
...
[source, java, indent=0]
----
include::{include_dir}/CreatingMultiTest.java[tag=generator]
----
...
Running the previous example gives the following numbers suite: `{2, 4, 7, 11, 17, 26, 40, 61}`.
